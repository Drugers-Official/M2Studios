...
export default function AboutPage() {
  const founders = [
    ...
    },
    {
      ...
      bio: "Expert in building scalable web applications and creating seamless digital experiences. Handles all technical aspects of M2 Studio's online presence.",
    },
  ]
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((value, index) => (
                ...
                >
                  <value.icon className="w-12 h-12 mx-auto mb-4" style={{ color: "#FACC15" }} />
